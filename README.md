...
│   ├── raw\_data.csv.dvc          # DVC tracked dataset

│   └── download\_data.py          # Dataset download script

│

├── src/

│   ├── pipeline\_components.py   # Kubeflow-style components

│   └── model\_training.py        # Training utilities

│

├── mlflow\_pipeline.py            # Main MLflow pipeline
